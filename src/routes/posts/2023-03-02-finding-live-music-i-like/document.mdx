...
Over the past few years, I’ve been using Resident Advisor’s [event page](https://ra.co/events) to find live music in NYC. While I’ve had fairly good success finding shows that I like, it can be daunting to find the right ones. On any given Friday there can be 40+ shows in NYC, where each show could have 8+ artists. If I wanted to figure out which show I’d most likely enjoy on that night, I’d have to look up 320 artist’s music pages, then listen to a few songs or mixes of theirs. Very tedious, and not a flowy, enjoyable way to experience music.
