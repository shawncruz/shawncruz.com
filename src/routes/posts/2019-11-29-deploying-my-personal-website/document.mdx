...
This is the first time I've ever deployed an application to the web. After completing my personal website locally, I needed to figure out a way to deploy it. 
